return {
  ...
  default: [
    ...
    // "/shaders/util/editor.js",
    // "/shaders/util/editor.s4r",
    // "/shaders/s4y/nye.js",
    // "/shaders/s4y/blue.s4r",
    // "/shaders/s4y/green.s4r",
    // "/shaders/util/black.frag",
    // "/shaders/util/grid.s4r",

    // "/shaders/s4y/blobs.s4r",
    // "/shaders/s4y/ram.s4r",
    ...
    // "/shaders/s4y/surfice.frag",

    // "/shaders/s4y/fademiddleround.s4r",


    // "/shaders/s4y/no_crypto.s4r",
    // "/shaders/s4y/key.s4r",


    // "/shaders/s4y/sf.s4r",
    // "/shaders/s4y/edges.frag",
    // "/shaders/s4y/rectish.s4r",
    // "/shaders/s4y/edges.frag",


    // "/shaders/s4y/spiral.s4r",
...
// 
...

    {
      ...
      params: {
        _amt: 0,
        amt(ctx) { this.params._amt *= 0.95; if (ctx.midi.button10) this.params._amt = 1; return this.params._amt; },
      },
...

    {
      ...
      if(ctx) { const ret = ctx.midi.button11; this.params.amt = (ret > 0) ? 1 : 0; return ret; },
    },

    {
      path: "/shaders/s4y/blackout.s4r",
      params: {
        brightness(ctx) { return ctx.midi.kbutton12 || ctx.midi.knob12; }
      },
